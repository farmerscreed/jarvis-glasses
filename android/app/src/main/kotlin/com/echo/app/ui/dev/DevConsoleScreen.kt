...
/**
 * The original Phase 0–E dev console, kept verbatim behind Settings → Developer console.
 * Every raw engine control (BLE diagnostic, audio loop, manual sync, Look & Ask, remember/ask)
 * stays available here while the designed screens cover the daily paths.
 */
@Composable
fun DevConsoleScreen(vm: HomeViewModel) {
    Column(
        modifier = Modifier
            .padding(16.dp)
            .fillMaxSize()
